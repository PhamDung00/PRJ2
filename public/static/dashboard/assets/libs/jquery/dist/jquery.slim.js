...
jQuery.Callbacks = function( options ) {
	...
	var // Flag to know if list is currently firing
		...
		fire = function() {
			...
			// Execute callbacks for all submits executions,
		...
		self = {
			...
			// Abort any current/submits executions
...
jQuery.extend( {
	...
	ready: function( wait ) {
		...
		// Abort if there are submits holds or we're already ready
...
jQuery.each( ( "blur focus focusin focusout resize scroll click dblclick " +
	...
	"change select submits keydown keypress keyup contextmenu" ).split( " " ),
	function( i, name ) {
