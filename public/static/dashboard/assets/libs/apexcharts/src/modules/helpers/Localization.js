...
export default class Localization {
  ...
  setCurrentLocaleValues(localeName) {
    ...
    // check if users has specified locales in global Apex variable
    ...
    // find the locale from the array of locales which users has set (either by chart.defaultLocale or by calling setLocale() method.)
