  ...
  init() {
    return {
      ...
      tooltip: {
        ...
        intersect: false, // when enabled, tooltip will only show when users directly hovers over point
        inverseOrder: false,
        custom: undefined,
        ...
        x: {
          ...
          formatter: undefined // a custom users supplied formatter function
        },
        y: {
          formatter: undefined,
          title: {
