  ...
  getyAxisLabelsCoords() {
    ...
    w.config.yaxis.map((yaxe, index) => {
      ...
      if (
        ...
        // the second parameter -1 is the index of tick which users can use in the formatter
        ...
        // if users has specified a custom formatter, and the result is null or empty, we need to discard the formatter and take the value as it is.
