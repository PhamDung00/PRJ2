...
export default class Theme {
  ...
  setDefaultColors() {
    ...
    if (w.config.colors === undefined) {
      ...
      // if users provided a function in colors, we need to eval here
      if (
    ...
    // users defined colors in series array
    ...
    // if users specified fewer colors than no. of series, push the same colors again
