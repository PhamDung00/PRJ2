    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            <div class="card shadow-lg">
                ...
                <div class="card-body">
                    <!-- Form -->
                    <form action="{{ route('dashboard.residents.update', $resident->id) }}" method="post">
                        @method('put')
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="name" id="" value="{{$resident->name}}" placeholder=" " required>
                                    <label for="">Name</label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="phone_number" id="" value="{{$resident->phone_number}}" placeholder=" "
                                           required>
